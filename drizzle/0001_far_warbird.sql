...
--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `role` enum('user','admin','manager','accountant','hr','sales') NOT NULL DEFAULT 'user';--> statement-breakpoint
ALTER TABLE `users` ADD `department` varchar(100);--> statement-breakpoint
ALTER TABLE `users` ADD `isActive` boolean DEFAULT true NOT NULL;--> statement-breakpoint
CREATE INDEX `account_code_idx` ON `accounts` (`accountCode`);--> statement-breakpoint
CREATE INDEX `account_type_idx` ON `accounts` (`accountType`);--> statement-breakpoint
CREATE INDEX `user_idx` ON `activityLog` (`userId`);--> statement-breakpoint
CREATE INDEX `entity_idx` ON `activityLog` (`entityType`,`entityId`);--> statement-breakpoint
CREATE INDEX `created_at_idx` ON `activityLog` (`createdAt`);--> statement-breakpoint
CREATE INDEX `bank_account_idx` ON `bankTransactions` (`bankAccountId`);--> statement-breakpoint
CREATE INDEX `transaction_date_idx` ON `bankTransactions` (`transactionDate`);--> statement-breakpoint
CREATE INDEX `reconciled_idx` ON `bankTransactions` (`isReconciled`);--> statement-breakpoint
...
CREATE INDEX `estimate_idx` ON `estimateItems` (`estimateId`);--> statement-breakpoint
CREATE INDEX `estimate_number_idx` ON `estimates` (`estimateNumber`);--> statement-breakpoint
CREATE INDEX `client_idx` ON `estimates` (`clientId`);--> statement-breakpoint
CREATE INDEX `status_idx` ON `estimates` (`status`);--> statement-breakpoint
...
CREATE INDEX `due_date_idx` ON `invoices` (`dueDate`);--> statement-breakpoint
CREATE INDEX `entry_date_idx` ON `journalEntries` (`entryDate`);--> statement-breakpoint
CREATE INDEX `entry_number_idx` ON `journalEntries` (`entryNumber`);--> statement-breakpoint
CREATE INDEX `journal_entry_idx` ON `journalEntryLines` (`journalEntryId`);--> statement-breakpoint
CREATE INDEX `account_idx` ON `journalEntryLines` (`accountId`);--> statement-breakpoint
CREATE INDEX `employee_idx` ON `leaveRequests` (`employeeId`);--> statement-breakpoint
CREATE INDEX `status_idx` ON `leaveRequests` (`status`);--> statement-breakpoint
CREATE INDEX `start_date_idx` ON `leaveRequests` (`startDate`);--> statement-breakpoint
CREATE INDEX `client_idx` ON `opportunities` (`clientId`);--> statement-breakpoint
CREATE INDEX `stage_idx` ON `opportunities` (`stage`);--> statement-breakpoint
CREATE INDEX `assigned_to_idx` ON `opportunities` (`assignedTo`);--> statement-breakpoint
CREATE INDEX `invoice_idx` ON `payments` (`invoiceId`);--> statement-breakpoint
CREATE INDEX `payment_date_idx` ON `payments` (`paymentDate`);--> statement-breakpoint
CREATE INDEX `employee_idx` ON `payroll` (`employeeId`);--> statement-breakpoint
CREATE INDEX `pay_period_idx` ON `payroll` (`payPeriodStart`,`payPeriodEnd`);--> statement-breakpoint
CREATE INDEX `status_idx` ON `payroll` (`status`);--> statement-breakpoint
