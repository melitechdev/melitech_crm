...
export default function EditOpportunity({ opportunityId }: EditOpportunityProps) {
  ...
  // Get opportunity ID from URL or props
  const id = opportunityId || new URLSearchParams(window.location.search).get("id");

  // Fetch opportunity data
  const { data: opportunity, isLoading } = trpc.opportunities.getById.useQuery(id || "", {
    enabled: !!id,
  });
